...
set(JSON_CONFIG_FILE_PATH "${CMAKE_SOURCE_DIR}/cmake/utils/VScodeJsonIni")
...
if(CMAKE_SYSTEM_PROCESSOR STREQUAL "ARM" AND
    ...
    find_program(CMAKE_GDB NAMES gdb)
    configure_file("${JSON_CONFIG_FILE_PATH}/launch_x86.in"
        "${CMAKE_SOURCE_DIR}/build/VScodeJson/launch.json")
endif()
